...
urlpatterns = [
    ...
    path('reviews/critic/update/<int:pk>/', CriticReviewUpdateView.as_view(), name="reviews-update"),
    path('reviews/critic/delete/<int:pk>/', CriticReviewDeleteView.as_view(), name="reviews-delete"),
    ...
    path('directors/update/<int:pk>/', DirectorUpdateView.as_view(), name="directors-update"),
    path('directors/delete/<int:pk>/', DirectorDeleteView.as_view(), name="directors-delete"),
]
